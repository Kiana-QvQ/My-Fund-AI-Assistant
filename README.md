...
> 🟡 今日短债建议：不按PE判断，也不要求一次补足；012773 长期目标还差 ¥3,100.00
...
|---|---:|---:|---:|---:|---|---|
| 沪深300 | `510300` | `460300` | 13.77 | 66.32% | 2026-07-15 | 分位≥40%，暂停新增 |
| 中证500 | `510500` | `160119` | 30.87 | 65.30% | 2026-07-15 | 分位≥40%，暂停新增 |
| 标普500 | `513500` | `050025` | 待核验 | 待核验 | 待核验 | 数据不足，暂停自动买入 |
| 纳斯达克100 | `159941` | `016452` | 待核验 | 待核验 | 待核验 | 数据不足，暂停自动买入 |

...
> 自动更新时间：**2026-07-17 16:34:29 CST**
> 建仓本金：**¥10,000.00** · 已投入：**¥2,000.00** · 整体建仓进度：**20.00%**
> 🟢 权益半额维持定投；短债本期不催补（012773 长期还差 ¥3,100.00）
...
- 沪深300：半额维持定投，1年分位72.4%，52周回撤7.1%
- 中证500：半额维持定投，1年分位85.6%，52周回撤11.9%
...
|---|---:|---:|---:|---:|---:|---:|---:|---|---|
| 沪深300 | `510300` | `460300` | 13.56 | 80.06% | 72.43% | 7.14% | - | 2026-07-16 | 半额维持定投 |
| 中证500 | `510500` | `160119` | 30.18 | 85.78% | 85.60% | 11.91% | - | 2026-07-16 | 半额维持定投 |
...
> A股近10年定投（放宽）：＜30%→300% / 30%~40%→200% / 40%~60%→100% / 60%~90%→50% / ≥90%停买；美股：＜40%→300% / 40%~50%→200% / 50%~70%→100% / 70%~90%→50% / ≥90%停买。1年建仓三档（与十年定投取较高者）：沪深300[1年≤50%→100%/1年≤70%→50%/1年≤90%→25%]；中证500[1年≤55%→100%/1年≤75%→50%/1年≤90%→25%]；标普500[1年≤50%→100%/1年≤70%→50%/1年≤85%→25%]；累计≤目标仓30%；纳指不自动；点位不单独触发。回撤很深且十年已在停买区则只观察、不因跌幅抄底；**指数绝对点位不单独触发买入**。标普用 Multpl 指数PE，四层校验通过才可交易判断。纳指 PE 来自 QQQ（stockanalysis/yfinance）**仅供参考**；样本不足时分位显示「无统计分位」。爬虫失败严禁用过期缓存做买卖。QDII溢价＞2%暂缓买入。短债012773不看PE/回撤，按建仓计划与申购状态。每月按交易日定时判断一次（非每日频繁切换）。
...
- **21:00**：有 A 股操作才发信 →「下一交易日 15:00 前申购」  
- **09:00**：有 A/美股操作才发信 →「今天 15:00 前申购」  
- **无买入/止盈操作不发邮件**（估值告警只写 Actions Summary）  

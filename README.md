...
> 自动更新时间：**2026-07-17 16:46:22 CST**
...
> A股/美股近10年定投：＜40%→300% / 40%~50%→200% / 50%~60%→150% / 60%~70%→100% / 70%~80%→70% / 80%~90%→50% / ≥90%停买。1年建仓三档（与十年定投取较高者）：沪深300[1年≤50%→100%/1年≤70%→50%/1年≤90%→25%]；中证500[1年≤55%→100%/1年≤75%→50%/1年≤90%→25%]；标普500[1年≤50%→100%/1年≤70%→50%/1年≤85%→25%]；累计≤目标仓30%；纳指不自动；点位不单独触发。定投提醒默认每月最多1封（`alerts.max_emails_per_month`，止盈可突破）。回撤很深且十年已在停买区则只观察；**指数绝对点位不单独触发买入**。标普须 Multpl 核验；纳指仅参考；QDII溢价＞2%暂缓。短债012773不看PE/回撤。每月按交易日定时判断，邮件不等于每天都要下单。

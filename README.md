...
> 自动更新时间：**2026-07-17 16:18:10 CST**
...
- 沪深300：高估观察，当前无持仓无需止盈，1年分位72.4%，52周回撤7.1%
- 中证500：高估观察，当前无持仓无需止盈，1年分位85.6%，52周回撤11.9%
...
|---|---:|---:|---:|---:|---:|---:|---:|---|---|
| 沪深300 | `510300` | `460300` | 13.56 | 80.06% | 72.43% | 7.14% | - | 2026-07-16 | 高估观察，当前无持仓无需止盈 |
| 中证500 | `510500` | `160119` | 30.18 | 85.78% | 85.60% | 11.91% | - | 2026-07-16 | 高估观察，当前无持仓无需止盈 |
...
> A股近10年分位分档（平衡型）：＜30%加倍 / 30%~40%满额 / 40%~60%半额 / ≥60%停买与止盈观察；美股：＜50%满额 / 50%~70%半额 / ≥70%停买。分指数微建仓（沪深300：1年≤60%+回撤≥6%+十年＜85%；中证500：1年≤70%+回撤≥8%+十年＜85%；标普500：1年≤60%+回撤≥8%；单次约目标仓5%、累计≤10%；纳指不自动；点位不单独触发）。回撤≥20%但十年PE仍在停买区则只观察、不因跌幅抄底；**指数绝对点位不单独触发买入**。标普用 Multpl 指数PE，四层校验通过才可交易判断。纳指 PE 来自 QQQ（stockanalysis/yfinance）**仅供参考**；样本不足时分位显示「无统计分位」。无持仓时高估只观察、不提示止盈（但仍可按微建仓规则小额试仓）。爬虫失败严禁用过期缓存做买卖。QDII溢价＞2%暂缓买入。短债012773不看PE/回撤，按建仓计划与申购状态。1万元本金微仓：单次约沪深300 135 / 中证500 55 / 标普500 40；累计上限约 270 / 110 / 80 元。

...
> 自动更新时间：**2026-07-17 10:45:54 CST**
...
| 标普500 | `513500` | `050025` | 32.41 | 93.33% | 4.90% | 2026-07-16 | 建议分批止盈 |
| 纳斯达克100 | `159941` | `016452` | 待核验 | 待核验 | 6.51% | 2026-07-17 | 未核验，禁止自动买入 |

> A股分位为近10年滚动PE；标普500 用 Multpl 指数PE（最新值+月度历史）本地算近10年分位，四层校验通过才可交易判断；纳指硬编码未核验、永不自动买入。爬虫失败严禁用过期缓存做买卖。QDII溢价按场内ETF相对IOPV计算，＞2%暂缓买入。
